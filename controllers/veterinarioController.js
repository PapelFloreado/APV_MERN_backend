...
import emailResetPassword from "../helpers/emailOlvidePassword.js"
...
const registrar = async(req, res)=>{
    ...
    try {
        ...
        const veterianrioGuardado = await veterinario.save()
...
const comprobarToken = async(req, res)=>{
    const { token } = req.params
    const validarToken = await Veterinario.findOne({token})
...
const actualizarPassword = async (req,res)=>{
    ...
    const {password_actual, nuevoPassword} = req.body
    ...
    if (veterinario.comprobarPassword(password_actual)) {
